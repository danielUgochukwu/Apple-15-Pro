      ...
      <div className="screen-max-width">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="chip-subtitle">
            It's here. The biggest redesign int he history of Apple GPUs.
          </p>
        </div>
        ...
        <div className="chip-text-container">
          <div className="flex flex-1 justify-center flex-col">
            <p className="chip-text g-fadeIn">
              A17 Pro is an entirely new class of iPhone chip that delivers our{" "}
              <span className="text-white">
                best graphics performers by far
              </span>
              .
            </p>
          ...
          <div className="flex flex-1 flex-col justify-center g-fadeIn">
